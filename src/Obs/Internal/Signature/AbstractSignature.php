...
use Juling\Filesystem\Obs\Internal\Common\SchemaFormatter;
use Juling\Filesystem\Obs\Internal\Common\Model;
use Juling\Filesystem\Obs\Internal\Common\ObsTransform;
use Juling\Filesystem\Obs\Internal\Common\V2Transform;
...
abstract class AbstractSignature implements SignatureInterface
{
    ...
    protected function prepareAuth(array &$requestConfig, array &$params, Model $model)
    {
        ...
        if ($xml || (isset($requestConfig['data']['xmlAllowEmpty']) && $requestConfig['data']['xmlAllowEmpty'])) {
            ...
            Log::debug('request content ' . $result['body']);
